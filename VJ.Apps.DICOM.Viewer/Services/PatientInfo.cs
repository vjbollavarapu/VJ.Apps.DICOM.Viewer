...
using System;
using VCS.Apps.Dicom.Viewer.Interfaces;
using VCS.Apps.Dicom.Viewer.Models;

namespace VCS.Apps.Dicom.Viewer.Services
{
    public class PatientInfo : IPatientInfo
    {
        private readonly ILogger<PatientInfo> _logger;
        public PatientInfo(ILogger<PatientInfo> logger) 
        {
            _logger = logger;
        }
        ...
        private void doQuery(List<string> properties, string dicomUrl)
        {
