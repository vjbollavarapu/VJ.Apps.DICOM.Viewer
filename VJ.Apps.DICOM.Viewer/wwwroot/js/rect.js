...
ovm.shape.rect = function(xPixelSpacing,yPixelSpacing,measure_Unit) {
	...
	/**
	 * getter for rectangles for the image Shown
	 * @returns {Array} List of rectangles drawn 
	 */
	...
	/**
	 *  Setter for rectangles for the image Shown
	 * @param rect
	 */
	this.setRectangles = function (rect) {
		rects = rect;
	};
