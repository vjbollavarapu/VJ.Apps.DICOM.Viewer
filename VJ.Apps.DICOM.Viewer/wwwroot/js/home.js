...
function openViewer(nTrContent) {
	let modality =  nTrContent[7];
	modality = modality.substring(0, modality.indexOf('</div>'));
...
function showWestPane(iPos) {
    ...
    var tmpUrl = "westContainer1.jsp?patient=" + encodeURIComponent(iPos[1]) + 
    		"&study=" + iPos[9] + "&patientName=" + encodeURIComponent(iPos[2]);
    tmpUrl += "&studyDesc=" + encodeURIComponent(iPos[5]) + 
    		"&studyDate=" + iPos[4]["display"].split(" ")[0] + 
    		"&totalSeries=" + iPos[10] + "&dcmURL=" + urlDcm;
